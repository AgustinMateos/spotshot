          ...
          <div className='flex w-full gap-6 flex-wrap flex-col md:flex-row items-start'>
            ...
            <div className="flex bg-[#F1F7FE] p-1 rounded-lg w-auto h-12.25">
              <button onClick={() => handleFilterChange('audience', 'FREE_SURFERS')}
                className={`px-6 py-2.5 rounded-lg text-[14px] font-medium transition-all ${filters.audience === 'FREE_SURFERS' ? 'bg-white shadow-sm text-gray-900' : 'bg-transparent text-gray-500 hover:text-gray-700'
                  }`}>
                Free Surfers
              </button>
              <button onClick={() => handleFilterChange('audience', 'SCHOOLS')}
                className={`px-6 py-2.5 rounded-lg text-[14px] font-medium transition-all ${filters.audience === 'SCHOOLS' ? 'bg-white shadow-sm text-gray-900' : 'bg-transparent text-gray-500 hover:text-gray-700'
                  }`}>
                Escuelas
              </button>
            </div>
            ...
            <div className="relative w-full md:w-56">
              ...
              {showStatusDropdown && (
                <div
                  className="absolute z-50 w-full mt-2 bg-white border border-gray-300 rounded-2xl shadow-xl py-2"
                  onClick={(e) => e.stopPropagation()}
                >
                  {['', 'DRAFT', 'PROCESSING', 'ACTIVE', 'DISABLED'].map((status) => (
                    <div
                      ...
                      className={`px-5 py-3 hover:bg-gray-50 cursor-pointer flex items-center gap-3 text-sm ${filters.status === status ? 'bg-blue-50 text-[#0D2744] font-medium' : 'text-gray-700'
                        }`}
                    >
                    ...
                    >
                      ...
                      {session.status !== 'DRAFT' && (
                        <button
                          ...
                          className={`w-full text-left px-5 py-3 hover:bg-gray-50 flex items-center gap-3 transition-all ${copiedId === session.id
