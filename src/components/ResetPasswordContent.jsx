      ...
      <div className="max-w-md w-full bg-white rounded-3xl shadow-xl p-10">
        ...
        {message ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {error && <p className="text-red-600 bg-red-50 py-3 rounded-xl text-center">{error}</p>}

            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gray-900 hover:bg-black text-white py-4 rounded-2xl font-semibold text-lg disabled:opacity-70"
            >
