...
export const playas = [
  ...
  { value: "Playa de la Zurriola País Vasco España", label: "Playa de la Zurriola, País Vasco" },
  { value: "Playa de la Concha País Vasco España", label: "Playa de la Concha, País Vasco" },
  { value: "Playa de Ondarreta Pikua País Vasco España", label: "Playa de Ondarreta, País Vasco" },
  { value: "Playa de Ondarreta Tenis País Vasco España", label: "Playa de Ondarreta, País Vasco" },
  { value: "Agiti País Vasco España", label: "Agiti, País Vasco" },
  { value: "Orio País Vasco España", label: "Orio, País Vasco" },
  { value: "Zarautz País Vasco España", label: "Zarautz, País Vasco" },
  { value: "Karramarro País Vasco España", label: "Karramarro, País Vasco, España" },
  { value: "Playa de Gaztetape País Vasco España", label: "Playa de Gaztetape, País Vasco, España" },
  { value: "Orrua Roca punta País Vasco España", label: "Orrua - Roca Punta, País Vasco, España" },
  { value: "Itzurun País Vasco España", label: "Itzurun, País Vasco, España" },
  { value: "Playa de Deba País Vasco España", label: "Playa de Deba, País Vasco, España" },
  { value: "Playa Alkolea País Vasco España", label: "Playa Alkolea , País Vasco, España" },
  { value: "Playa de Karraspio País Vasco España", label: "Playa de Karraspio País Vasco, España" },
  { value: "Playa de Ogeia País Vasco España", label: "Playa de Ogeia, País Vasco, España" },
  { value: "Playa de Laga País Vasco España", label: "Playa de Laga, País Vasco, España" },
  { value: "Playa de Anzoras-Laila País Vasco España", label: "Playa de Anzoras-Laila, País Vasco, España" },
  { value: "Mundaka País Vasco España", label: "Mundaka, País Vasco, España" },
  { value: "Aritzatxu País Vasco España", label: "Aritzatxu , País Vasco, España" },
  { value: "Playa de Bakio País Vasco España", label: "Playa de Bakio, País Vasco, España" },
  { value: "Cala de Basordas País Vasco España", label: "Cala de Basordas, País Vasco, España" },
  { value: "Playa de Plentzia País Vasco España", label: "Playa de Plentzia, País Vasco, España" },
  { value: "Playa de Barrica País Vasco España", label: "Playa de Barrica, País Vasco, España" },
  { value: "Cala Meñacoz País Vasco España", label: "Cala Meñacoz, País Vasco, España" },
  { value: "Playa de Atxabirbil País Vasco España", label: "Playa de Atxabirbil, País Vasco, España" },
  { value: "Playa de Arrietara País Vasco España", label: "Playa de Arrietara, País Vasco, España" },
  { value: "Playa la Salvaje País Vasco España", label: "Playa la Salvaje, País Vasco, España" },
  { value: "Playa de Azkorri País Vasco España", label: "Playa de Azkorri, País Vasco, España" },
  { value: "Punta Galea País Vasco España", label: "Punta Galea, País Vasco, España" },
  { value: "Playa de Alcorta País Vasco España", label: "Playa de Alcorta, País Vasco, España" },
  { value: "Playa de Ereaga País Vasco España", label: "Playa de Ereaga, País Vasco, España" },
  { value: "Playa de la Arena País Vasco España", label: "Playa de la Arena, País Vasco, España" },
  { value: "Playa de Brazomar Cantabria España", label: "Playa de Brazomar, Cantabria, España" },
  { value: "Playa de Arenillas Cantabria España", label: "Playa de Arenillas, Cantabria, España" },
  { value: "Playa de Oriñon Cantabria España", label: "Playa de Oriñon, Cantabria, España" },
  { value: "Playa de San Julián Cantabria España", label: "Playa de San Julián, Cantabria, España" },
  { value: "Playa de Laredo Cantabria España", label: "Playa de Laredo, Cantabria, España" },
  { value: "La Fortaleza Cantabria España", label: "La Fortaleza, Cantabria, España" },
  { value: "Playa de Berria Cantabria España", label: "Playa de Berria, Cantabria, España" },
  { value: "Playa de Trengandin El Brusco Cantabria España", label: "Playa de Trengandin - El Brusco, Cantabria, España" },
  { value: "Playa de el Ris Cantabria España", label: "Playa de El Ris, Cantabria, España" },
  { value: "Playa del Arenal Cantabria España", label: "Playa del Arenal, Cantabria, España" },
  { value: "Playa de Cuberris Cantabria España", label: "Playa de Cuberris, España" },
  ...
  { value: "Playa el Sardinero Cantabria España", label: "Playa el Sardinero, Cantabria, España" },
  { value: "Playa de Canallave Cantabria España", label: "Playa de Canallave, Cantabria, España" },
  { value: "Playa de Valdearenas Cantabria España", label: "Playa de Valdearenas, Cantabria, España" },
  { value: "Playa de Robayera Cantabria España", label: "Playa de Robayera, Cantabria, España" },
  { value: "Playa de Usgo Cantabria España", label: "Playa de Usgo, Cantabria, España" },
  { value: "Playa de los Caballos Cantabria España", label: "Playa de los Caballos, Cantabria, España" },
  { value: "Playa de la Concha Cantabria España", label: "Playa de la Concha, Cantabria, España" },
  { value: "Los Locos Los Locos Cantabria España", label: "Los Locos, Cantabria, España" },
  { value: "Playa de la Tablia Cantabria España", label: "Playa de la Tablia, Cantabria, España" },
  { value: "Playa el Sable Cantabria España", label: "Playa el Sable, Cantabria, España" },
  { value: "Playa de Cóbreces Cantabria España", label: "Playa de Cóbreces, Cantabria, España" },
  { value: "Playa de Oyambre Cantabria España", label: "Playa de Oyambre, Cantabria, España" },
  { value: "Playa de Gerra San Vicente Cantabria España", label: "Playa de Gerra - San Vicente, Cantabria, España" },
  { value: "San Vicente La Barquera Cantabria España", label: "San Vicente La Barquera, Cantabria, España" },
  { value: "Playa de Merón Cantabria España", label: "Playa de Merón, Cantabria, España" },
  { value: "Punta Liñera Cantabria España", label: "Punta Liñera, Cantabria, España" },
  { value: "Playa de Mendía Mendia Asturias España", label: "Playa de Mendía, Asturias, España" },
  { value: "Playa de Vidiago Asturias España", label: "Playa de Vidiago, Asturias, España" },
  { value: "Playa de Andrín Asturias España", label: "Playa de Andrín, Asturias, España" },
  { value: "Playa de Ballota Asturias España", label: "Playa de Ballota, Asturias, España" },
  { value: "Playa de San Martin Asturias España", label: "Playa de San Martín, Asturias, España" },
  { value: "Playa de Niembro Asturias España", label: "Playa de Niembro, Asturias, España" },
  { value: "Playa de Torimbia Asturias España", label: "Playa de Torimbia, Asturias, España" },
  { value: "Playa de San Antolín Asturias España", label: "Playa de San Antolín, Asturias, España" },
  { value: "Playa de Santa Marina Asturias España", label: "Playa de Santa Marina, Asturias, España" },
  { value: "Playa de Vega Vega Asturias España", label: "Playa de Vega, Asturias, España" },
  { value: "Playa Arenal de Moris Asturias España", label: "Playa Arenal de Moris, Asturias, España" },
  { value: "Playa Espasa Asturias España", label: "Playa Espasa, Asturias, España" },
  { value: "Playa de la Isla Playa Asturias España", label: "Playa de la Isla, Asturias, España" },
  { value: "Playa de la Griega La Griega Asturias España", label: "Playa de la Griega, Asturias, España" },
  { value: "Cabo Lastres Asturias España", label: "Cabo Lastres, Asturias, España" },
  { value: "Ensenada de la Conejera Ensenada Asturias España", label: "Ensenada de la Conejera, Asturias, España" },
  { value: "Playa de Rodiles Asturias España", label: "Playa de Rodiles, Asturias, España" },
  { value: "Ría Rodiles Asturias España", label: "Ría Rodiles, Asturias, España" },
  { value: "Playa de Merón Asturias España", label: "Playa de Merón, Asturias, España" },
  { value: "Playa de la Ñora Asturias España", label: "Playa de la Ñora, Asturias, España" },
  { value: "Playa de Peñarrubia Asturias España", label: "Playa de Peñarrubia, Asturias, España" },
  { value: "Playa de Cervigón Asturias España", label: "Playa de Cervigón, Asturias, España" },
  { value: "El Mongol Asturias España", label: "El Mongol, Asturias, España" },
  { value: "La Roca Asturias España", label: "La Roca, Asturias, España" },
  { value: "Playa de San Lorenzo Asturias España", label: "Playa de San Lorenzo, Asturias, España" },
  ...
  { value: "Playa del Tranqueru Asturias España", label: "Playa del Tranqueru - Tranqueru, Asturias, España" },
  { value: "Playa de Carranques Asturias España", label: "Playa de Carranques - Carranques, Asturias, España" },
  { value: "Playa de la Palmera Asturias España", label: "Playa de la Palmera, Asturias, España" },
  { value: "La Llastra Asturias España", label: "La Llastra, Asturias, España" },
  { value: "Playa de Luanco Asturias España", label: "Playa de Luanco, Asturias, España" },
  { value: "Playa Bañuges Asturias España", label: "Playa Bañuges, Asturias, España" },
  ...
  { value: "El Cartel Canarias España", label: "El Cartel, Canarias, España" },
  { value: "Jameos del Agua Canarias España", label: "Jameos del Agua, Canarias, España" },
  { value: "Caleta del Mero Canarias España", label: "Caleta del Mero, Canarias, España" },
  ...
  { value: "Caleta Caballo  Canarias España", label: "Caleta Caballo, Canarias, España" },
  { value: "El Complejo Canarias España", label: "El Complejo, Canarias, España" },
  { value: "La Santa Canarias España", label: "La Santa, Canarias, España" },
  { value: "El Quemao Canarias España", label: "El Quemao, Canarias, España" },
  { value: "Playa del Ingles Playa del Ingles Canarias España", label: "Playa del Inglés - Playa del Inglés, Canarias, España" },
  { value: "Playa de las Burras Canarias España", label: "Playa de las Burras, Canarias, España" },
  { value: "Playa de TarajilloCanarias España", label: "Playa de Tarajillo, Canarias, España" },
  { value: "El Castillo del Romeral Canarias España", label: "El Castillo del Romeral, Canarias, España" },
  ...
  { value: "Playa de Arinaga Canarias España", label: "Playa de Arinaga, Canarias, España" },
  { value: "El Muelle Viejo Canarias España", label: "El Muelle Viejo, Canarias, España" },
  { value: "Playa de Melenara Canarias España", label: "Playa de Melenara, Canarias, España" },
  { value: "Playa del Hombre Canarias España", label: "Playa del Hombre, Canarias, España" },
  { value: "Playa de San Borondon Canarias España", label: "Playa de San Borondón, Canarias, España" },
  { value: "Pico de la Laja La Laja Canarias España", label: "Pico de la Laja, Canarias, España" },
  ...
  { value: "Playa de la Aldea Canarias España", label: "Playa de la Aldea, Canarias, España" },
  { value: "Playa de Tauro Punta del Tablero Canarias España", label: "Playa de Tauro - Punta del Tablero, Canarias, España" },
  { value: "Playa de Arguineguín Canarias España", label: "Playa de Arguineguín, Canarias, España" },
  { value: "El Callao Canarias España", label: "El Callao, Canarias, España" },
  { value: "El Charco Bajamar Canarias España", label: "El Charco - Bajamar, Canarias, España" },
  { value: "El Ancon Canarias España", label: "El Ancón, Canarias, España" },
  { value: "Los Patos Canarias España", label: "Los Patos, Canarias, España" },
  { value: "Playa El Socorro Canarias España", label: "Playa El Socorro - El Socorro, Canarias, España" },
  { value: "La Caleta Canarias España", label: "La Caleta, Canarias, España" },
  { value: "Playa de Las Conchas Canarias España", label: "Playa de Las Conchas, Canarias, España" },
  ...
  { value: "La Fitenia Canarias España", label: "La Fitenia, Canarias, España" },
  { value: "Playa de las Galletas Canarias España", label: "Playa de las Galletas, Canarias, España" },
  { value: "Playa de la Tejita Canarias España", label: "Playa de la Tejita, Canarias, España" },
  { value: "La Machacona Canarias España", label: "La Machacona - Machacona, Canarias, España" },
  { value: "Porís de Abona Canarias España", label: "Porís de Abona, Canarias, España" },
  { value: "Igueste de San Andres Canarias España", label: "Igueste de San Andrés, Canarias, España" },
  { value: "Burro Burro Canarias España", label: "Burro - Burro, Canarias, España" },
  { value: "Punta Elena Canarias España", label: "Punta Elena - Punta Elena, Canarias, España" },
  ...
  { value: "Isla de Lobos Canarias España", label: "Isla de Lobos, Canarias, España" },
  { value: "Bristol Corralejo Canarias España", label: "Bristol - Corralejo, Canarias, España" },
  { value: "La Generosa La generosa Canarias España", label: "La Generosa, Canarias, España" },
  ...
  { value: "Playa de el Cotillo El Cotillo Canarias España", label: "Playa de El Cotillo  Canarias, España" },
  { value: "Playa La Pared Playa del Viejo Rey Canarias España", label: "Playa La Pared - Playa del Viejo Rey, Canarias, España" },
  { value: "Playa de Cofete España", label: "Playa de Cofete, Canarias, España" },
  { value: "Playa de Butihondo Canarias España", label: "Playa de Butihondo Canarias, España" },
  { value: "Cruz Roja - Jandía Canarias España", label: "Cruz Roja - Jandía, Canarias, España" }
];
