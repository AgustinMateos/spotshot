...
export const playas = [
  ...
  { value: "Playa de Gaztetape País Vasco España", label: "Playa de Gaztetape - Gaztetape, País Vasco, España" },
  ...
  { value: "Playa de Deba País Vasco España", label: "Playa de Deba - Deba, País Vasco, España" },
  { value: "Playa Alkolea País Vasco España", label: "Playa Alkolea - Alkolea, País Vasco, España" },
  { value: "Playa de Karraspio País Vasco España", label: "Playa de Karraspio - Karraspio, País Vasco, España" },
  { value: "Playa de Ogeia País Vasco España", label: "Playa de Ogeia - Ogeia, País Vasco, España" },
  { value: "Playa de Laga País Vasco España", label: "Playa de Laga - Laga, País Vasco, España" },
  { value: "Playa de Anzoras-Laila Anzoras - Laila País Vasco España", label: "Playa de Anzoras-Laila - Anzoras, País Vasco, España" },
  { value: "Mundaka País Vasco España", label: "Mundaka - Mundaka, País Vasco, España" },
  { value: "Aritzatxu País Vasco España", label: "Aritzatxu - Aritzatxu, País Vasco, España" },
  { value: "Playa de Bakio País Vasco España", label: "Playa de Bakio - Bakio, País Vasco, España" },
  { value: "Cala de Basordas País Vasco España", label: "Cala de Basordas - Basordas, País Vasco, España" },
  { value: "Playa de Plentzia País Vasco España", label: "Playa de Plentzia - Plentzia, País Vasco, España" },
  { value: "Playa de Barrica País Vasco España", label: "Playa de Barrica - Barrica, País Vasco, España" },
  { value: "Cala Meñacoz País Vasco España", label: "Cala Meñacoz - Meñacoz, País Vasco, España" },
  { value: "Playa de Atxabirbil País Vasco España", label: "Playa de Atxabirbil - Atxabirbil, País Vasco, España" },
  { value: "Playa de Arrietara País Vasco España", label: "Playa de Arrietara - Arrietara, País Vasco, España" },
  { value: "Playa la Salvaje País Vasco España", label: "Playa la Salvaje - Salvaje, País Vasco, España" },
  { value: "Playa de Azkorri País Vasco España", label: "Playa de Azkorri - Azkorri, País Vasco, España" },
  { value: "Punta Galea Punta País Vasco España", label: "Punta Galea - Punta Galea, País Vasco, España" },
  { value: "Playa de Alcorta País Vasco España", label: "Playa de Alcorta - Alcorta, País Vasco, España" },
  { value: "Playa de Ereaga País Vasco España", label: "Playa de Ereaga - Ereaga, País Vasco, España" },
  { value: "Playa de la Arena País Vasco España", label: "Playa de la Arena - La Arena, País Vasco, España" },
  { value: "Playa de Brazomar Cantabria España", label: "Playa de Brazomar - Brazomar, Cantabria, España" },
  { value: "Playa de Arenillas Cantabria España", label: "Playa de Arenillas - Arenillas, Cantabria, España" },
  { value: "Playa de Oriñon Cantabria España", label: "Playa de Oriñon - Oriñon, Cantabria, España" },
  { value: "Playa de San Julián Cantabria España", label: "Playa de San Julián - San Julián, Cantabria, España" },
  { value: "Playa de Laredo Cantabria España", label: "Playa de Laredo - Laredo, Cantabria, España" },
  { value: "La Fortaleza Cantabria España", label: "La Fortaleza - La Fortaleza, Cantabria, España" },
  { value: "Playa de Berria Cantabria España", label: "Playa de Berria - Berria, Cantabria, España" },
  { value: "Playa de Trengandin El Brusco Cantabria España", label: "Playa de Trengandin - El Brusco, Cantabria, España" },
  { value: "Playa de el Ris Cantabria España", label: "Playa de El Ris - El Ris, Cantabria, España" },
  { value: "Playa del Arenal (Cantabria) El Arenal Cantabria España", label: "Playa del Arenal - El Arenal, Cantabria, España" },
  { value: "Playa de Cuberris Cantabria España", label: "Playa de Cuberris - Cuberris, Cantabria, España" },
  { value: "Playa de Antuerta / Ajo Cantabria España", label: "Playa de Antuerta - Antuerta / Ajo, Cantabria, España" },
  { value: "Playa de Galizano Cantabria España", label: "Playa de Galizano - Galizano, Cantabria, España" },
  ...
  { value: "Playa de la Tablia Cantabria España", label: "Playa de la Tablia - La Tablia, Cantabria, España" },
  { value: "Playa el Sable Cantabria España", label: "Playa el Sable - El Sable, Cantabria, España" },
  { value: "Playa de Cóbreces Cantabria España", label: "Playa de Cóbreces - Cobreces, Cantabria, España" },
  { value: "Playa de Oyambre Cantabria España", label: "Playa de Oyambre - Oyambre, Cantabria, España" },
  ...
  { value: "Playa de Niembro Asturias España", label: "Playa de Niembro - Niembro, Asturias, España" },
  { value: "Playa de Torimbia Torimbia Asturias España", label: "Playa de Torimbia - Torimbia, Asturias, España" },
  { value: "Playa de San Antolín Asturias España", label: "Playa de San Antolín - San Antolín, Asturias, España" },
  ...
  { value: "Playa de Rodiles Asturias España", label: "Playa de Rodiles - Rodiles, Asturias, España" },
  { value: "Ría Rodiles Ria rodiles Asturias España", label: "Ría Rodiles - Ría Rodiles, Asturias, España" },
  { value: "Playa de Merón Asturias España", label: "Playa de Merón - Merón, Asturias, España" },
  ...
  { value: "Playa de Cofete Cofete España", label: "Playa de Cofete - Cofete, Canarias, España" },
  { value: "Playa de Butihondo Canarias España", label: "Playa de Butihondo - Butihondo, Canarias, España" },
